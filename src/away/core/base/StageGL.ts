...
module away.base
{
	...
	export class StageGL extends away.events.EventDispatcher
	{
		...
		private _renderTarget:away.gl.TextureBase = null;
		...
		public get renderTarget():away.gl.TextureBase
		{
		...
		public setRenderTarget(target:away.gl.TextureBase, enableDepthAndStencil:boolean = false, surfaceSelector:number = 0)
		{
