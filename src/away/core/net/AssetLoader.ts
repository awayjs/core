	...
	export class AssetLoader extends away.events.EventDispatcher
	{
		...
		private retrieveNext(parser:away.parsers.ParserBase = null)
		{
			if (this._loadingDependency.dependencies.length) {
				...
				var dep:away.parsers.ResourceDependency = this._loadingDependency.dependencies.pop();
				...
				var prev:away.parsers.ResourceDependency = this._loadingDependency;
		 ...
		 * @param parser The parser that will translate the data into a usable resource.
		 */
		private retrieveDependency(dependency:away.parsers.ResourceDependency, parser:away.parsers.ParserBase = null)
		{
			var data:any;
