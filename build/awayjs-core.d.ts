...
declare module "awayjs-core/lib/containers/Scene" {
	import DisplayObjectContainer = require("awayjs-core/lib/containers/DisplayObjectContainer");
	import DisplayObject = require("awayjs-core/lib/core/base/DisplayObject");
	import Partition = require("awayjs-core/lib/core/partition/Partition");
	...
	class Scene extends EventDispatcher {
	    ...
	    constructor();
	    public traversePartitions(traverser: ICollector): void;
	    ...
	    * @internal
	    */
	    public iRegisterEntity(displayObject: DisplayObject): void;
	    /**
	    * @internal
	    */
	    public iRegisterPartition(partition: Partition): void;
	    /**
	    * @internal
	    */
	    public iUnregisterEntity(displayObject: DisplayObject): void;
	    /**
	    * @internal
	    */
	    public iUnregisterPartition(partition: Partition): void;
	}
	export = Scene;
	
}
declare module "awayjs-core/lib/containers/View" {
	import Scene = require("awayjs-core/lib/containers/Scene");
	import Vector3D = require("awayjs-core/lib/core/geom/Vector3D");
	...
	class View {
	    ...
	    *
	    */
	    public iEntityCollector : ICollector;
	    /**
	    *
	    */
...
declare module "awayjs-core/lib/controllers/ControllerBase" {
	import DisplayObject = require("awayjs-core/lib/core/base/DisplayObject");
	class ControllerBase {
	    ...
	    public targetObject : DisplayObject;
...
declare module "awayjs-core/lib/controllers/FirstPersonController" {
...
declare module "awayjs-core/lib/entities/Skybox" {
	import IAnimator = require("awayjs-core/lib/animators/IAnimator");
	import BoundingVolumeBase = require("awayjs-core/lib/bounds/BoundingVolumeBase");
	import DisplayObject = require("awayjs-core/lib/core/base/DisplayObject");
	import IMaterialOwner = require("awayjs-core/lib/core/base/IMaterialOwner");
...
declare module "awayjs-core/lib/entities/TextField" {
	import DisplayObject = require("awayjs-core/lib/core/base/DisplayObject");
...
declare module "awayjs-core/lib/materials/MaterialBase" {
	...
	*/
	class MaterialBase extends NamedAssetBase implements IAsset {
	    ...
	    * @private
	    */
	    public _iActivatePass(pass: IMaterialPassData, stage: IStage, camera: Camera): void;
	    /**
	    ...
	    * @internal
	    */
	    public _iDeactivatePass(pass: IMaterialPassData, stage: IStage): void;
	    /**
	    ...
	    * @internal
	    */
	    public _iRenderPass(pass: IMaterialPassData, renderable: IRenderable, stage: IStage, camera: Camera, viewProjection: Matrix3D): void;
	    /**
	    ...
	    * @internal
	    */
	    public iAddOwner(owner: IMaterialOwner): void;
	    /**
	    ...
	    * @internal
	    */
	    public iRemoveOwner(owner: IMaterialOwner): void;
	    /**
	    * A list of the IMaterialOwners that use this material
	    *
	    * @private
	    */
	    public iOwners : IMaterialOwner[];
	    /**
	    ...
	    */
	    ...
	    public _pNotifySizeChanged(): void;
...
declare module "awayjs-core/lib/core/base/CapsStyle" {
	/**
...
declare module "awayjs-core/lib/core/base/DisplayObject" {
	...
	*/
	class DisplayObject extends NamedAssetBase implements IBitmapDrawable {
	    ...
	    public _pSceneTransform: Matrix3D;
	    ...
	    public _pRenderables: IRenderable[];
	    ...
	    *
	    */
	    public bounds : BoundingVolumeBase;
	    /**
	    ...
	    *
	    */
	    public inverseSceneTransform : Matrix3D;
	    /**
	    *
	    */
	    ...
	    *
	    */
	    public worldBounds : BoundingVolumeBase;
	    /**
	    ...
	    * @internal
	    */
	    public _iAssignedPartition : Partition;
	    /**
...
declare module "awayjs-core/lib/core/base/IBitmapDrawable" {
	/**
...
declare module "awayjs-core/lib/core/base/JointStyle" {
	/**
...
declare module "awayjs-core/lib/core/base/OrientationMode" {
...
declare module "awayjs-core/lib/core/base/PixelSnapping" {
	/**
...
declare module "awayjs-core/lib/core/base/SubGeometryBase" {
	import Geometry = require("awayjs-core/lib/core/base/Geometry");
...
declare module "awayjs-core/lib/core/base/SubMeshBase" {
	import IAnimator = require("awayjs-core/lib/animators/IAnimator");
	import Matrix3D = require("awayjs-core/lib/core/geom/Matrix3D");
	import UVTransform = require("awayjs-core/lib/core/geom/UVTransform");
	import NamedAssetBase = require("awayjs-core/lib/core/library/NamedAssetBase");
...
declare module "awayjs-core/lib/core/base/TriangleCulling" {
	/**
...
declare module "awayjs-core/lib/core/base/TriangleSubGeometry" {
	import SubGeometryBase = require("awayjs-core/lib/core/base/SubGeometryBase");
	import Matrix3D = require("awayjs-core/lib/core/geom/Matrix3D");
	/**
	* @class away.base.TriangleSubGeometry
...
declare module "awayjs-core/lib/core/base/TriangleSubMesh" {
	import ISubMesh = require("awayjs-core/lib/core/base/ISubMesh");
	import SubMeshBase = require("awayjs-core/lib/core/base/SubMeshBase");
...
declare module "awayjs-core/lib/core/geom/Box" {
	import Vector3D = require("awayjs-core/lib/core/geom/Vector3D");
	/**
...
declare module "awayjs-core/lib/core/geom/ColorTransform" {
	/**
...
declare module "awayjs-core/lib/core/geom/Matrix3DUtils" {
...
declare module "awayjs-core/lib/core/geom/Plane3D" {
	import Vector3D = require("awayjs-core/lib/core/geom/Vector3D");
	class Plane3D {
	    /**
...
declare module "awayjs-core/lib/core/geom/PlaneClassification" {
...
declare module "awayjs-core/lib/core/geom/Point" {
	/**
...
declare module "awayjs-core/lib/core/geom/Transform" {
	import DisplayObject = require("awayjs-core/lib/core/base/DisplayObject");
	import ColorTransform = require("awayjs-core/lib/core/geom/ColorTransform");
	import Matrix = require("awayjs-core/lib/core/geom/Matrix");
	import Matrix3D = require("awayjs-core/lib/core/geom/Matrix3D");
...
declare module "awayjs-core/lib/core/library/ErrorConflictStrategy" {
	import ConflictStrategyBase = require("awayjs-core/lib/core/library/ConflictStrategyBase");
	import IAsset = require("awayjs-core/lib/core/library/IAsset");
...
declare module "awayjs-core/lib/core/library/IAsset" {
	import IEventDispatcher = require("awayjs-core/lib/events/IEventDispatcher");
...
declare module "awayjs-core/lib/core/library/IDUtil" {
	class IDUtil {
	    /**
	    *  @private
...
declare module "awayjs-core/lib/core/library/IgnoreConflictStrategy" {
	import ConflictStrategyBase = require("awayjs-core/lib/core/library/ConflictStrategyBase");
	import IAsset = require("awayjs-core/lib/core/library/IAsset");
...
declare module "awayjs-core/lib/core/library/NamedAssetBase" {
	import EventDispatcher = require("awayjs-core/lib/events/EventDispatcher");
