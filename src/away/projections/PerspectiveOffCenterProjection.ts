...
{
	export class PerspectiveOffCenterProjection extends ProjectionBase
	{
		...
		{
			var clone:PerspectiveOffCenterProjection = new PerspectiveOffCenterProjection(this._minAngleX, this._maxAngleX, this._minAngleY, this._maxAngleY);
