...
interface ICoreExports {
    ...
    Matrix_copy(dst: WASMMatrix, src: WASMMatrix): void;
    Matrix_createBox(mat: WASMMatrix, scaleX: number, scaleY: number, rotation: number, tx: number, ty: number): void;
